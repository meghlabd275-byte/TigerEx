...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.error || 'Failed to fetch webhooks' },
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.error || 'Failed to create webhook' },
        { status: response.status }
      );
    }
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (!response.ok) {
      return NextResponse.json(
        { success: false, error: data.error || 'Failed to delete webhook' },
        { status: response.status }
      );
    }
